...
void func( decltype(safe_map_strings_global) safe_map_strings )
{
	...
	std::cout << "potato is " << readonly_safe_map_string->at("potato").first << " " << readonly_safe_map_string->at("potato").second << "\n";
	std::cout << "apple is " << readonly_safe_map_string->at("apple").first << " " << readonly_safe_map_string->at("apple").second << "\n";
}
